...
class ShareRepository:
    ...
    def upsert_note_share(self, note_id:int, user_id:int, role:ShareRole) -> NoteShare:
        share = self.db.exec(
    ...
    def upsert_label_share(self, label_id:int, user_id:int, role:ShareRole) -> LabelShare:
        share = self.db.exec(
            select(LabelShare).where(
                LabelShare.label_id == label_id, 
    ...
    def is_note_share(self, note_id:int, user_id:int, role: str | None = None) -> bool:
    ...
    def has_any_label_share(self, label_ids: list[int], user_id:int, role: ShareRole | None = None) -> bool:
    ...
    def list_note_ids_shared_with_user(self, user_id:int ) -> list[int]:
        return self.db.exec(
